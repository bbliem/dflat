cxxflags="-DPROGRESS_REPORT=1 -DWITH_NODE_TIMER" # additional flags, like, e.g., -DVERBOSE
#cxxflags="-DVERBOSE -DPROGRESS_REPORT=1" # additional flags, like, e.g., -DVERBOSE
